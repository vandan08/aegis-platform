...
/**
 * JPA persistence shape for an OAuth2 registered client. Multi-valued fields
 * (methods, grant types, redirect URIs, scopes) are stored comma-delimited and the
 * two settings blobs as JSON; {@link JpaRegisteredClientRepository} converts to and
 * from Spring's {@code RegisteredClient}.
 */
@Entity
